...
# Print model info
print(paste('convergence =', MTME.z_rr1ap1rc.asr$converge))
MTME.z_rr1ap1rc.asr$trace |>
...
# Update model ----
MTME.z_rr1ap1rc.asr <- update_asreml(MTME.z_rr1ap1rc.asr, 
                                 max_updates = 100,
                                 save_path = 'Data/MTME.z_rr1ap1rc.RData')
