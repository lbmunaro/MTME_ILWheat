...
# Print model info
print(paste('convergence =', MTME.z_rr6a.asr$converge))
MTME.z_rr6a.asr$trace |>
  as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Save
save.image('Data/MTME.z_rr6a.RData')

# Update model ----
MTME.z_rr6a.asr <- update_asreml(MTME.z_rr6a.asr, 
                                 max_updates = 20,
                                 save_path = "Data/MTME.z_rr6a.RData")
