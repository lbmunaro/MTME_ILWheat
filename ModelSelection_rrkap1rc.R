...
lrt.asreml(MTME.z_rr1ap1rc.asr,MTME.z_rr2ap1rc.asr,MTME.z_rr3ap1rc.asr,
           MTME.z_rr4ap1rc.asr,MTME.z_rr5ap1rc.asr,MTME.z_rr6ap1rc.asr
           )
...
VaPct_rrap1rc <- data.frame(TraitEnv = levels(ILYT_Pheno$TraitEnv)) |>
  ...
  pivot_longer(cols = c(rr1ap1rc:rr6ap1rc), names_to = 'model', values_to = 'VaPct') |>
