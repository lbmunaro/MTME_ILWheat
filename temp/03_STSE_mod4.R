...
#   residual = ~ dsum(~ IDEU:us(Tr2) | Env, levels = tr2) +
#     dsum(~ IDEU:us(Tr3) | Env, levels = tr3) +
#     dsum(~ IDEU:us(Tr4) | Env, levels = tr4) +
#     dsum(~ IDEU:us(Tr5) | Env, levels = tr5),
...
# )
# print('STSE_4')
# print(summary(STSE_4.asr)$call)
# STSE_4.asr$loglik
# print('AIC')
# print(summary(STSE_4.asr)$aic)
# print(paste('convergence =',STSE_4.asr$converge))
# 
# ## Save data ----
# save.image('Data/STSE_mod4.RData')

## Load
load('Data/STSE_mod4.RData')

STSE_4.asr <- update(STSE_4.asr)

print('STSE_4 - Update 1')
print(summary(STSE_4.asr)$call)
STSE_4.asr$loglik
print('AIC')
print(summary(STSE_4.asr)$aic)
