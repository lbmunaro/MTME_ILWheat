...
STSE_6.asr <- asreml(
  ...
  residual = ~ dsum(~ IDEU:sfa(Tr2,2) | Env, levels = tr2) +
    dsum(~ IDEU:sfa(Tr3,2) | Env, levels = tr3) +
    dsum(~ IDEU:sfa(Tr4,2) | Env, levels = tr4) +
    dsum(~ IDEU:sfa(Tr5,2) | Env, levels = tr5),
...
print('STSE_6')
print(summary(STSE_6.asr)$call)
STSE_6.asr$loglik
print('AIC')
print(summary(STSE_6.asr)$aic)
print(STSE_6.asr$noeff)
print(paste('convergence =',STSE_6.asr$converge))

## Save data ----
save.image('Data/STSE_mod6.RData')