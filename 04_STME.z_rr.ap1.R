...
# Print model info
print('GY_STME.z_rr4')
print(paste('convergence =',GY_STME.z_rr4ap1.asr$converge))
GY_STME.z_rr4ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
GY_STME.z_rr4ap1.asr <- update_asreml(GY_STME.z_rr4ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('GY_STME.z_rr5')
print(paste('convergence =',GY_STME.z_rr5ap1.asr$converge))
GY_STME.z_rr5ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
GY_STME.z_rr5ap1.asr <- update_asreml(GY_STME.z_rr5ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('GY_STME.z_rr6')
print(paste('convergence =',GY_STME.z_rr6ap1.asr$converge))
GY_STME.z_rr6ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
GY_STME.z_rr6ap1.asr <- update_asreml(GY_STME.z_rr6ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('TW_STME.z_rr4')
print(paste('convergence =',TW_STME.z_rr4ap1.asr$converge))
TW_STME.z_rr4ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
TW_STME.z_rr4ap1.asr <- update_asreml(TW_STME.z_rr4ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('TW_STME.z_rr5')
print(paste('convergence =',TW_STME.z_rr5ap1.asr$converge))
TW_STME.z_rr5ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
TW_STME.z_rr5ap1.asr <- update_asreml(TW_STME.z_rr5ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('TW_STME.z_rr6')
print(paste('convergence =',TW_STME.z_rr6ap1.asr$converge))
TW_STME.z_rr6ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
TW_STME.z_rr6ap1.asr <- update_asreml(TW_STME.z_rr6ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('HD_STME.z_rr4')
print(paste('convergence =',HD_STME.z_rr4ap1.asr$converge))
HD_STME.z_rr4ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
HD_STME.z_rr4ap1.asr <- update_asreml(HD_STME.z_rr4ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('HD_STME.z_rr5')
print(paste('convergence =',HD_STME.z_rr5ap1.asr$converge))
HD_STME.z_rr5ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
HD_STME.z_rr5ap1.asr <- update_asreml(HD_STME.z_rr5ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('HT_STME.z_rr4')
print(paste('convergence =',HT_STME.z_rr4ap1.asr$converge))
HT_STME.z_rr4ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
HT_STME.z_rr4ap1.asr <- update_asreml(HT_STME.z_rr4ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
...
# Print model info
print('HT_STME.z_rr5')
print(paste('convergence =',HT_STME.z_rr5ap1.asr$converge))
HT_STME.z_rr5ap1.asr$trace |> as.data.frame() |> rownames_to_column('Iteration') |>
  filter(Iteration=='LogLik') |> print()

# Update model
HT_STME.z_rr5ap1.asr <- update_asreml(HT_STME.z_rr5ap1.asr, 
                                      max_updates = 20,
                                      save_path = 'Data/STME.z_rr.ap1.RData')
